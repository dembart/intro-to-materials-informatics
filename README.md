...
* [Анкета оценки курса](#анкета-оценки-курса)
...
- применять библиотеки Python и инструменты науки о данных для решения задач материаловедения
- критически оценивать научную литературу по информатике материалов
- собирать, генерировать и анализировать наборы данных в области материаловедения, включая выявление связей между структурой и свойствами материалов
...
Python-библиотека для построения декскрипторов атомных структур.
...
На рисунке ниже представлены ответы студентов на вопросы, которые мы задавали им после первого запуска курса.

- Вопрос №1. Было ли вам удобно использовать Github для навигации по курсу?

- Вопрос №2. Оцените по 7-балльной шкале (7 — наивысший балл), в какой степени, по вашему мнению, вы достигли результата обучения «Применять библиотеки Python и инструменты науки о данных для решения задач материаловедения».

- Вопрос №3. Оцените по 7-балльной шкале (7 — наивысший балл), в какой степени, по вашему мнению, вы достигли результата обучения «Критически оценивать литературу по информатике материалов».

- Вопрос №4. Оцените по 7-балльной шкале (7 — наивысший балл), в какой степени, по вашему мнению, вы достигли результата обучения «Собирать, генерировать и анализировать наборы данных в области материаловедения, включая выявление связей между структурой и свойствами материалов».

![Оценка курса](figures/first_run.png)

Опросник адаптирован из статьи [Using Jupyter Tools to Design an Interactive Textbook to Guide Undergraduate Research in Materials Informatics](https://pubs.acs.org/doi/10.1021/acs.jchemed.2c00640)

</details>

<details>
<summary> Второй запуск </summary>

На рисунке ниже представлены ответы студентов на вопросы, которые мы задавали им после второго запуска курса.
...
- Вопрос №5. Оцените по 7-балльной шкале (7 — наивысший балл), в какой степени вы использовали большие языковые модели для выполнения заданий?

![Оценка курса](figures/second_run.png)

Опросник (вопросы 1–4) адаптирован из статьи [Using Jupyter Tools to Design an Interactive Textbook to Guide Undergraduate Research in Materials Informatics](https://pubs.acs.org/doi/10.1021/acs.jchemed.2c00640)
