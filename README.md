...
|<a id="4">4</a> <br> (Date: Oct. 7)| [Lecture 4](lectures/lecture04_Exploratory_data_analysis.pdf) <br> Agenda: Exploratory data analysis.|Seminar 4 <br> Agenda: scipy, matplotlib, pandas, EDA|       |  [Lecture from CS 109a course by Pavlos Protopapas & Kevin Rader](https://harvard-iacs.github.io/2018-CS109A/lectures/lecture-3/presentation/lecture3.pdf)    |
